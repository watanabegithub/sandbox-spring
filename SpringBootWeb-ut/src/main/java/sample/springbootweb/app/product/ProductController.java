...
public class ProductController {
    ...
    public  String  input(Model model) {
        logger.info("ProductController input");
        model.addAttribute("productForm", setupForm());
    ...
    public  String  confirm(Model model, @Valid ProductForm productForm, Errors errors) {
        errors.rejectValue("productCode", "duplicate", "商品コード");
        if (errors.hasErrors()) {
            return "product/input";
        }
        logger.info("form.productName:"+productForm.getProductName());
